...
<head lang="en">
    <meta charset="UTF-8">
    <link type="text/css" rel="stylesheet" href="<%=path%>/css/admin_newsdetail.css">
        ...
        <div class="content-middle2">
            ...
            <div class="content-middle2-content">
                ...
                <div class="content-middle3">
                    ...
                    <div class="content-middle3-right">
                        <div class="content-middle3-right-none">
							<img  src="admin_adminAction_drawOneByNum?imageId=<%=fullNews.getNews().getImageid() %>" width="150px" height="150px"/>
						</div>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="content-middle3 mt-80">
                    <button class="score-btn2" onclick="window.location.href='admin_adminAction_listAllNews'">返回</button>
                </div>
            </div>
        </div>
        <div class="clear"></div>
