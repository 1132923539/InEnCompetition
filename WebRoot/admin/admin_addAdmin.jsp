...
<head lang="en">
    <meta charset="UTF-8">
    <link type="text/css" rel="stylesheet" href="<%=path%>/css/admin_addadmin.css">
...
<div class="content">
    ...
    <div class="content-middle">
        ...
        <div class="content-middle2">
            ...
            <form method="post" id="addAdmin" class="addAdmin" action="admin_adminAction_doAddAdmin" enctype="multipart/form-data">
                <div class="content-middle2-content">
                    <div class="content-middle3">
                        ...
                        <div class="content-middle3-right">
                            <input type="text" placeholder="姓名" datatype="*1-15" nullmsg="姓名不能为空" errormsg="最多15个字！" name="name">
                    ...
                    <div class="content-middle3 mt-150">
	                    <div class="content-middle3-left">
	                        备注：
	                    </div>
	                    <div class="content-middle3-right">
                    ...
                    <div class="content-middle3">
                        <button class="score-btn2">提交</button>
                    </div>
                </div>
            </form>
        </div>
...
<script type="text/javascript" src="<%=path%>/js/admin_addAdmin.js"></script>
</body>
</html>