            ...
            <div class="content-middle2-content">
                <div class="content-middle3">
                    ...
                    <div class="content-middle3-right">
                        <div class="content-middle3-right-none"><%=admin.getName() %></div>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="content-middle3">
                    ...
                    <div class="content-middle3-right">
                        <div class="content-middle3-right-none">
							<%if(admin.getSex()==0){out.print("男");}else{out.print("女");} %>
						</div>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="content-middle3">
                    ...
                    <div class="content-middle3-right">
                        <div class="content-middle3-right-none">
							...
							<%}else{ %>
								<img  src="admin_adminAction_drawOneByNum?imageId=<%=admin.getImageid() %>" width="150px" height="150px"/>
							<%} %>
						</div>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="content-middle3 mt-80">
                    ...
                    <div class="content-middle3-right">
                        ...
                        <div class="content-middle3-right-none">
                        	<%if(admin.getRemark()!=null){out.print(admin.getRemark());}else{out.print("");} %>
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
