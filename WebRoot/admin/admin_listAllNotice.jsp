...
<head lang="en">
    <meta charset="UTF-8">
    <link type="text/css" rel="stylesheet" href="<%=path%>/css/admin_noticelist.css">
    ...
    <div class="content-middle">
        ...
        <div class="content-middle2">
            <div class="content-middle2-title">
                ...
                <span>|</span>
                <span>大赛公告列表</span>
                <div class="addtea"><a href="admin_adminAction_addNotice">新增大赛公告</a></div>
            </div>
            <div class="content-middle2-search">
            	<form method="post" action="admin_adminAction_listAllNotice">
                ...
                <div class="table-tr-td">
                    ...
                    <div class="table-td-222">
                        <div class="ck-details">
                            <a href="admin_adminAction_detailNotice?newsId=<%=listFullNews.get(i).getNews().getId()%>">查看信息</a>
                        </div>
                        <div class="ck-details2">
                        	<%if(listFullNews.get(i).getNews().getSysstatus()==1){ %>
                            	<a href="javascript:void(0);" onclick="return delNotice('<%=listFullNews.get(i).getNews().getId()%>');">删除</a>
                        	<%}else{ %>
                        		<a href="javascript:void(0);" onclick="return redNotice('<%=listFullNews.get(i).getNews().getId()%>');">还原</a>
                        	<%} %>
                        </div>
                    </div>
                    <div class="clear"></div>
...
<script type="text/javascript" src="<%=path%>/js/admin_listAllNotice.js"></script>
