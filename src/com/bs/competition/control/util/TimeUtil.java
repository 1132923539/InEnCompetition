...
public class TimeUtil {
	 ...
	 * @return 时间string
	 */
	public static String dateFormateYMDHMS(Date date) {
		if (date == null)
			return "";
	 ...
	 * @return 时间string
	 */
	public static String dateFormateY(Date date) {
		if (date == null)
			return "";
	 ...
	 * @return 时间string
	 */
	public static String dateFormateALL2(Date date) {
		if (date == null)
			return "";
